      ...
      <div className="container-xxl">
        <div className="row">
          <div className="col-4">
            ...
            <div>
              <address className='text-white fs-6'>Hno : 277 Near Stupid Building, <br></br>
                Yellow city, Brown Province <br></br>
                PostCode: NotGivingItToYa.
              </address>
              <a href="tel:+99 9876356756" className="mt-3 d-block mb-1 text-white">
                +99 9876356756
              </a>
              <a href="mailto:njbnkjg@gmail.com" className="mt-2 d-block mb-0 text-white">
                njbnkjg@gmail.com
              </a>
